...
public class EpicTest {
    ...
    void epicStatusTest() {
        ...
        Assertions.assertEquals(Status.NEW, epic1.getStatusTask(), "Статус расчитан не верно");
        ...
        Assertions.assertEquals(Status.DONE, epic2.getStatusTask(), "Статус рассчитан не верно");
        ...
        Assertions.assertEquals(Status.IN_PROGRESS, epic3.getStatusTask(), "Статус рассчитан не верно");
        ...
        Assertions.assertEquals(Status.IN_PROGRESS, epic4.getStatusTask(), "Статус рассчитан не верно");
    }
}
